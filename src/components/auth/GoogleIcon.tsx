...
/**
 * GoogleIcon component for use in buttons
 * Accessible SVG version of Google branding for sign-in buttons
 */
const GoogleIcon = ({ className = "mr-2 h-4 w-4" }) => (
  <svg
    className={className}
    viewBox="0 0 48 48"
    aria-hidden="true"
  ...
  >
    ...
    />
    <path d="M1 1h46v46H1z" fill="none" />
  </svg>
);
